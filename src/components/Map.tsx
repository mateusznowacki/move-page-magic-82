            ...
            map.current.on('load', () => {
              ...
              if (map.current) {
                ...
                if (mapType === 'berlin') {
                  ...
                  // Load the GeoJSON data to get all German states
                  fetch('/germany-states-low.geojson')
                    .then(response => response.json())
                    .then(data => {
                      if (map.current) {
                        // Add all states as a source
                        ...
                        // Get all state features for bounds calculation
